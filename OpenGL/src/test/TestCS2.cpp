...
namespace test
{
        ...
        //m_View(glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -3.0f)))
    {
        ...
        m_VertexBuffer = std::make_unique <VertexBuffer>(position, 5 * 36 * sizeof(float));
    ...
    void TestCS2::OnUpdate(float delaTime)
    {

    }

    void TestCS2::OnRender()
    {
        ...
        {
            // Coordinate system part with rotating cube
